...
import Image from 'next/image'; // Import Image from next/image for the background
...
const HeroContent = () => {
  return (
    <div className="hero-section relative w-full h-screen bg-cover bg-center bg-no-repeat overflow-hidden">
      {/* Wrapper div for the background image */}
      <div className="absolute inset-0 z-[-1] bg-[url('/herobg-1.png')] bg-cover bg-center bg-no-repeat" style={{ backgroundPosition: '10% center' }}>
        {/* Alternatively, you can use 'backgroundPosition: 'right center'' or any value you prefer */}
      </div>
